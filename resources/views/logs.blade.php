...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      ...
      <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <button type="button" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-red-500 hover:bg-red-600 hover:shadow-lg" onclick="header.location = '/delete_logs'">Danger</button>
      </div>
    </div>
